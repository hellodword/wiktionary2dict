...
class Wiktionary2Dict:
    ...
    def run():
        ...
        with open('./data/sample.mdx.1', 'wb') as output_header, open('./data/sample.mdx.2', 'wb') as output_2, open('./data/sample.mdx.3', 'wb') as output_key_block_body_body, open('./data/sample.mdx.4', 'wb') as output_4, open('./data/sample.mdx.5', 'wb') as output_record_block_body_body,  open('./data/sample.mdx.record_temp', 'wb+') as output_record_temp:
            ...
            parse_wiktionary('./data/en.sample.xml.bz2', wikitext_cb=wikitext_cb, redirect_cb=redirect_cb)
